 ...
 * This socket is passed to PhysicsMult_BT
 * 
 **********************************************************************************/

@TargetApi(5)
public class PhysicsM extends Activity{
...
private static ConnectThread mConnectThread;
	...
	private void makeModeDialog() {
		...
		modeDialog.setNegativeButton("Client", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface arg0, int arg1) {
				Intent serverIntent = new Intent(PhysicsM.this, DeviceListActivity.class);
 ...
 * Creates a thread which listens for incoming connection and passes socket to class PhysicsMult_BT when socket connection is established
 * 
 **********************************************************************************/
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                PhysicsMult_BT.setBluetoothSocket(socket);
                
                Intent i=new Intent(PhysicsM.this,PhysicsMult_BT.class);
 ...
 * Creates a thread which attempts to connect to another device and passes socket to PhysicsMult_BT when socket connection is established
 * 
 **********************************************************************************/
...
private class ConnectThread extends Thread {
    ...
    public void run() {
        ...
        try {
        	...
        	PhysicsMult_BT.setBluetoothSocket(mmSocket);
        	Intent i=new Intent(PhysicsM.this,PhysicsMult_BT.class);
        	finish();
